...
navigate('/result')
  ...
  return (
   ...
   transition={{delay: 0.2, duration:0.8}}
      ...
      <motion.button onClick={onClickHandler} className='cursor-pointer sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full '
